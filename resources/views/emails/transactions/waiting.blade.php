...
<img style="text-align: center;width: 100px;height: 100px;display: block;margin: auto" src="https://sesur2.herokuapp.com/images/pending.png" style="height:150px;width: 150px;" alt="email"  /> <br>
...
<hr width="60%" color="#C6CFDB" style="margin-bottom: 5px;margin-top: 3px;">
 <p style="text-align: center">
Vous devez utiliser ce code <span style="font-weight: bold">{{$transaction->code}}</span>  comme motif pour votre opération
 </p>
