@component('mail::message')
    ...
    <img style="text-align: center;width: 100px;height: 100px;display: block;margin: auto"
         src="https://sesur2.herokuapp.com/images/failed.png" style="height:150px;width: 150px;" alt="email"/> <br>
    <h4 style="text-align: center">Votre transaction {{$transaction->code}} est échoué</h4>
