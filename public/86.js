  ...
  methods: {
    ...
    search: function search() {
      ...
      this.$store.dispatch("dashboardSearch", this.requestFilteredData).then(function () {
        _this7.dialogResult = true;
        console.log(_this7.dialogResult);
      });
    },
    ...
    exportAsPdf: function exportAsPdf() {
      ...
      doc.autoTable({
        head: [['Intitule', 'Derniere valeur', 'Dernier renseignement', 'Valeur precedente', 'Renseignement precedent']],
        body: this.dashboardResult.indis.map(function (e) {
          return [e.intitule, e.valeurs.length ? e.valeurs[0].valeur : '', e.valeurs.length ? e.valeurs[0].date : '', e.valeurs.length && e.valeurs.length > 1 ? e.valeurs[1].valeur : '', e.valeurs.length && e.valeurs.length > 1 ? e.valeurs[1].date : ''];
        }),
        startY: 50
      });
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    ref: "document",
                    staticStyle: { "max-width": "2480px" },
                    attrs: { slot: "pdf-content", id: "dash-to-export" },
                    slot: "pdf-content"
                  },
                  [
                          ...
                          _c(
                            ...
                            [
                              _c(
                                "v-col",
                                {
                                  staticClass: " text-center white--text my-0",
                                  attrs: {
                                    cols: "12",
                                    xl: "5",
                                    lg: "5",
                              ...
                              _c(
                                ...
                                {
                                  staticClass: " text-center white--text my-0",
                                  staticStyle: { "font-family": "'Louguiya'" },
                                  attrs: {
                                    cols: "12",
                                    xl: "5",
                                    lg: "5",
